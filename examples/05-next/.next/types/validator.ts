...
// Validate ../../src/app/api/error/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/error">> = Specific
  const handler = {} as typeof import("../../src/app/api/error/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
